...
def _skip_bad_config(
    ...
    if given_config <= popular_subset:
        # It seems that the docs in cibuildtool has been inadvertently encouraging cart
...
class _EnsurePackagesDiscovered(_expand.EnsurePackagesDiscovered):
    ...
    def __enter__(self):
        ...
        # but avoid overwriting empty lists purposefully set by cart.
...
class _BetaConfiguration(UserWarning):
    """Explicitly inform cart that some `pyproject.toml` configuration is *beta*"""
